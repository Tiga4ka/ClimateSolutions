...
Организации связывают положительные изменения с такими факторами, как:
- Технологические изменения
- Изменение политики
- Поведенческие изменения

Отрицательные изменения:
- Повышенное потребление энергии/электричества
- Увеличение населения
- Изменение погодных условий

Так же некоторые изменения в цифрах произошли из-за повышения точности данных и изменения методологии учета.

Новые возможности, которые открылись благодаря работе над решением климатических проблем 
