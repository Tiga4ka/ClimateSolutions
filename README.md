# ClimateSolutions
## Рассматриваем отчеты CDP в поисках решений климатических проблем
...
Мы рассмотрим данные отчета The Carbon Disclosure Project (CDP), в котором содержатся ответы властей городов со всего мира на вопросы анкеты.
...
Следующие сферы городской жизни наиболее подвержены климатическим рискам: **здравоохранение, водоснабжение и водоотведение, окружающая среда, биоразнообразие.**
</br>
Для 66% городов климатические изменения несут угрозу для здравоохранения.
</br>
</br>
...
Самыми частыми проблемами здравоохранения в связи с изменением климата являются **заболевания, связанные с жарой, загрязнением воздуха и инфекции, распространяемые насекомыми.**
...
Для адаптации к изменениям принимаются такие меры, как: 
- Картирование паводков
- Высадка деревьев
- Работа с общественностью
- Включение изменения климата в документы долгосрочного планирования
- Кризисное управление, включая системы оповещения и эвакуации
...
| Waste                                          | 139             | 13.064  |
| Building and Infrastructure                    | 131             | 12.312  |
| Water                                          | 81              | 7.613   |
| Business and Financial Services                | 58              | 5.451   |
| Agriculture and Forestry                       | 51              | 4.793   |
| Industry                                       | 42              | 3.947   |
| Social Services                                | 34              | 3.195   |
| Spatial Planning                               | 34              | 3.195   |
| ICT (Information and Communication Technology) | 24              | 2.256   |
| Public Health and Safety                       | 19              | 1.786   |
| Fishery                                        | 8               | 0.752   |


45% организаций отметили уменьшение количества выбросов парниковых газов с момента предыдущего отчёта, 21% - увеличение.

[<img width="578" alt="2023-01-19_165754" src="https://user-images.githubusercontent.com/79177126/213461458-5511a216-46c6-4c19-8570-167a11b3e98c.png">](https://public.tableau.com/views/ClimateSolutions_Changes/Changes?:language=en-US&publish=yes&:display_count=n&:origin=viz_share_link)

Организации связывают положительные изменения с такими факторами, как **технологические изменения, изменения политики, поведенческие изменения.**
</br>Отрицательные изменения связывают с **повышением потребления энергии, ростом населения.**
</br>Так же некоторые изменения в цифрах произошли из-за повышения точности данных и изменения методологии учета.

Благодаря работе над решением климатических проблем окрылся целый ряд новых возможностей:
- **Разработка технологий энергоэффективности**
- **Развитие устойчивого транспортного сектора**
- **Повышение эффективности муниципальных операций**
- **Развитие сектора обращения с отходами**
- **Разработка проектов устойчивости к изменению климата**
- **Развитие чистых технологий в бизнесе**
- **Расширение возможностей для партнерства**
- **Повышенная энергетическая безопасность**

[<img width="515" alt="2023-01-19_170847" src="https://user-images.githubusercontent.com/79177126/213464441-ef8f8f78-aa35-4ac8-ac0d-781eb3ef4e35.png">](https://public.tableau.com/views/ClimateSolutions_Bonuses/Bonuses?:language=en-US&publish=yes&:display_count=n&:origin=viz_share_link)


### Вывод 

Природные катаклизмы, вызванные изменением климата, а так же загрязнение воздуха в городах ведет к ухудшению ситуации для здравоохранения, водоснабжения и окружающей среды. 

Для борьбы с изменением климата и адаптации к его последствиям города ставят своей целью уменьшить количество выбросов, перейти на возобновляемые источники энергии, а так же повысить энергоэффективность существующей инфраструктуры. Так же оптимизируют системы по утилизации отходов и разрабатывают меры по борьбе с климатическими рисками.

Важной частью адаптации являются работа с бизнесом, общественностью, кризисное управление (оповещения и эвакуация), проектирование устойчивой к опасностям инфраструктуры.

Значительных изменений удается достичь благодаря развитию технологий и их финансированию.

Тем не менее рост населения и повышение потребления электроэнергии в городах негативно влияют на устойчивое развитие.
